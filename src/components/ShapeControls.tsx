                ...
                >
                    {controls
                        ...
                        .map((control) => (
                            ...
                            >
                                <div
                                    className={`group relative py-0.5 ${control.showKey && shape[control.showKey as keyof Shape]
                                        ? 'w-max'
                                        : 'w-max'
                                        }`}
                                >
                                    ...
                                    {control.strengthKey &&
                                        ...
                                        shape[control.showKey as keyof Shape] && (
                                            <div
                                                className={`mt-0.5 pl-1 pr-2 relative ${shape[control.showKey as keyof Shape] ? 'block' : 'hidden'
                                                    }`}
