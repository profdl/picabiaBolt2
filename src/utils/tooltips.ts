...
export const getControlDescription = (type: ControlType) => {
  const descriptions = {
    Depth:
      "Generates a depth map of your image. Use this depth map to control the spatial relationships when generating a new image.",
    Edges:
      "Creates an edge detection map of your image. Use this to control the composition of your generated images.",
